...
const testimonials = [
  [
    [
      ...
      {
        body: 'This service has transformed my business. Highly recommended!',
        author: {
          name: 'Avery Lentz',
          handle: 'averylentz',
          imageUrl: 'https://images.unsplash.com/photo-1521747116042-5a810fda9664?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
        },
      },
    ],
    [
  ...
  [
    [
      {
        body: 'Voluptas quos itaque ipsam in voluptatem est. Iste eos blanditiis repudiandae.',
        author: {
          name: 'Tom Cook',
          handle: 'tomcook',
    ...
    [
      {
        body: 'Molestias ea earum quos nostrum doloremque sed. Quaerat quasi aut velit incidunt.',
        author: {
      ...
      {
        body: 'The best decision I ever made was working with this team. Outstanding results!',
        author: {
          name: 'George Mills',
          handle: 'georgemills',
          imageUrl: 'https://images.unsplash.com/photo-1504215682096-547f77bc19e2?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
        },
      },
    ],
  ],
    ...
    <div className="relative isolate bg-black pb-32 pt-24 sm:pt-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-xl text-center">
          <h2 className="text-lg font-semibold leading-8 tracking-tight text-white">Testimonials</h2>
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-white sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
          <figure className="rounded-2xl bg-gray-800 shadow-lg ring-1 ring-gray-900/5 sm:col-span-2 xl:col-start-2 xl:row-end-1">
                ...
                >
                  {column.map((testimonial) => (
                    <figure
                      ...
                      className="rounded-2xl bg-gray-800 p-6 shadow-lg ring-1 ring-gray-900/5 transition-transform transform hover:scale-105 hover:shadow-xl"
                    >
